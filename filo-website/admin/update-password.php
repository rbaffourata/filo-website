...
<?php   
                ...
                //check whetehr submit button is clicked or not
                if(isset($_POST['submit']))
                {
                    ...
                    $id=$_POST['id'];
                    $ccurrent_password = md5($_POST['current_password']);
                    $current_password = mysqli_real_escape_string($conn, $ccurrent_password);

                    $nnew_password = md5($_POST['new_password']);
                    $new_password = mysqli_real_escape_string($conn, $new_password);

                    $cconfirm_password = md5($_POST['confirm_password']);
